...
---
//saadams// Adding a table of contents might be nice (especially since there are a few steps asked of us for this assignment)
...
library(curl)
```
//saadams// If I'm not mistaken, I think it may be redundant to load dplyr and ggplot2 here because I'm pretty sure it's included in tidyverse!
...
//saadams// I really like how you reference the modules the information came from. I remember us talking about it in class but I forgot to implement this as a I went along with this assignment. I think I will try to do this as I go along with my work next time!
...
```
//saadams// for line 60: I think && (or &) is more appropriate because I think they wrote in the module both things have to be true (|| means OR)
//saadams// lines 87 & 88: Check you equations, i think it should be ...* sqrt(p0 * (1 - p0) / n1) at the end (p1 written instead of p0)
//saadams// line 93: I split them! So for each case I wrote a few lines of code rather than for them both at once!
...
```
//saadams// this is a really good idea. I think I initially thought we would be using this function for Task 2, but I should test mine like this since I didn't.
...
print(plot_lm)
```
//saadams// I really like how you included the information for label = in here. I had a separate block to make my formula but this seems way more efficient! Besides that our plots are pretty similar
...
ci_lm_log
```
//saadams// I did pretty much the same thing - I think you just need an interpretation of the results :)
...
```
//saadams// so I actually did length.out = nrow(kamilar_cooper). Also, I might remove na earlier (like right after you load it) just to avoid any issues with any code you write. Besides that I also sequenced with the min and max range!
...
print(plot_predict)
```
//saadams// your way of making the new plot reads much nicer then how I did it (adding line by line) - nice!
...
predict_lm
```
//saadams// I like how you did 262 in one line (I did mine in 2) - much better for condensing code!
...
//saadams// I came to the same conclusion :)